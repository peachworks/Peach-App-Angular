/** cakeItemsDBTags service
 * Service which will be used to load tags data from ItemsDB with our magical wtm_inv_item_db object
...
/**
 * Can be used to load itemsDB tags data from db
...
_this.getData = function(findParams, otherParams) {
  ...
  otherParams['object'] = cakeCommon.getItemDBObjectKey('tags');
